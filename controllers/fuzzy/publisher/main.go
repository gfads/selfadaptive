...
func main() { // Windows
	...
	var sampleSizePtr = flag.Int("sample-size", 1000, "sample-size is an int")
	var meanRequestTimePtr = flag.Int("mean-request-time", 10, "mean-request-time is an int (ms)")
	var stdDevMeanRequestTimePtr = flag.Int("std-dev-mean-request-time", 2, "std-dev-mean-request-time is an int")
	var numberOfClients = flag.Int("number-of-clients", 1, "number-of-clients is an int")
	//flag.Parse()
