...
# AsTAR
CMD ["./subscriber","-is-adaptive=true", "-execution-type=StaticGoal", "-controller-type=AsTAR", "-monitor-interval=5", "-prefetch-count=1", "-max=10000", "-min=1", "-set-point=1000", "-direction=1", "-optimum-level=1000", "-shutoff-level=200"]
