...
import (
	"plugin"
	"selfadaptive/example-plugin-v2/sharedadaptive"
	"selfadaptive/example-plugin/v2/environment/plugins/manager"
	sharedadaptive2 "selfadaptive/example-plugin/v2/sharedadaptive"
	"selfadaptive/shared"
	"sync"
)
...
func (Environment) senseLocal() map[string]plugin.Plugin { // Executable
	...
	LocalPlugins = manager.MyPlugin{}.LoadPlugins(sharedadaptive2.DIR_EXECUTABLE_PLUGINS.DIR_EXECUTABLE_PLUGINS_LOCAL)
