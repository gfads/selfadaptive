...
func NewManagingSystem(ms managed.Managed, mapek *MAPEK) ManagingSystem {
	...
	// Configure mnged system (Monitor and Executor only as they are the ones to interact with the mnged system)
	if mapek.M != nil {
	...
	// Configure MAPEK of all mnging system's components
